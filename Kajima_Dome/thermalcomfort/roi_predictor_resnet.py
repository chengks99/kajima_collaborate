...
model_train = dict(
    ...
    cate_predictor=dict(
        ...
        outchannels=category_num,
        loss_cate=dict(type='CELoss', ratio=1, weight=None, reduction='mean')),
    pretrained='DF2ClothPred_resnet/gn20.pth')
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        img_path=os.path.join(data_root, 'trainalignExtend/images'),
        img_file=os.path.join(data_root, 'trainalignExtend/rimg.txt'),
        label_file=os.path.join(data_root, 'trainalignExtend/rnattr.txt'),
        cate_file=os.path.join(data_root, 'trainalignExtend/rcat.txt'),
        bbox_file=os.path.join(data_root, 'trainalignExtend/rbbox.txt'),
        landmark_file=os.path.join(data_root, 'trainalignExtend/rlmk.txt'),
        img_size=img_size),
    # train=dict(
    #     type=dataset_type,
    #     img_path=os.path.join(data_root, 'ImgOri'),
    ...
    test=dict(
        type=dataset_type,
        img_path=os.path.join(data_root, 'valalignExtend/images'),
        img_file=os.path.join(data_root, 'valalignExtend/img.txt'),
        label_file=os.path.join(data_root, 'valalignExtend/nattr.txt'),
        cate_file=os.path.join(data_root, 'valalignExtend/cat.txt'),
        bbox_file=os.path.join(data_root, 'valalignExtend/bbox.txt'),
        landmark_file=os.path.join(data_root, 'valalignExtend/lmk.txt'),
        attr_cloth_file=os.path.join(data_root,
                                     'valalignExtend/list_attr_cloth.txt'),
        cate_cloth_file=os.path.join(data_root,
                                     'valalignExtend/list_category_cloth.txt'),
        img_size=img_size),
    # test=dict(
    #     type=dataset_type,
    #     img_path=os.path.join(data_root, 'ImgOri'),
...
work_dir = 'checkpoint/CateAttrPredict/resnet_Augs2/roi'
