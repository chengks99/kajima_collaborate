...
class ClothPredictor():
    ...
    def __load_model(self, ca_model):
        ...
        load_checkpoint(self.clothmodel,
                        ca_model, map_location='cpu')
    ...
    def __preprocess(self, image_bgr, lmk):
        ...
        frame1 = cv2.resize(frame1, dsize=(224, 224))
        ...
        frame2 = cv2.resize(frame2, dsize=(224, 224))
        ...
        frame3 = cv2.resize(frame3, dsize=(224, 224))

        ## require eight (5,6,7,8,11,12,13,14) skeleton points in order for cloth model 
        vlmk1 = []
        for i in [5, 6, 7, 8, 11, 12]:
            vlmk1.append([int(transformed_points1[i][0]*(224/oriw1)),
                         int(transformed_points1[i][1]*(224/orih1))])

        vlmk1.extend([[0,0]]*2)
        
        vlmk2 = [[0,0]]*4
        for i in [11, 12, 13, 14]:
            vlmk2.append([int(transformed_points2[i][0]*(224/oriw2)),
                         int(transformed_points2[i][1]*(224/orih2))])
            
        vlmk3 = []
        for i in [5, 6, 7, 8, 11, 12, 13, 14]:
            vlmk3.append([int(transformed_points3[i][0]*(224/oriw3)),
                         int(transformed_points3[i][1]*(224/orih3))])
